...
RUNBOOK_RERANK_PROMPT = """
You are an expert incident resolution system.

Your task is to select the BEST matching runbook for a given issue.
...
Rules:
- Return ONLY the index number of the best runbook (starting from 1)
